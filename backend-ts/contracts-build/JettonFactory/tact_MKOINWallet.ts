...
export function dictValueParserJettonFactory$Data(): DictionaryValue<JettonFactory$Data> {
 ...
 type MKOINWallet_init_args = {
    $$type: 'MKOINWallet_init_args';
    master: Address;
    owner: Address;
}

function initMKOINWallet_init_args(src: MKOINWallet_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.master);
        b_0.storeAddress(src.owner);
...
async function MKOINWallet_init(master: Address, owner: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initMKOINWallet_init_args({ $$type: 'MKOINWallet_init_args', master, owner })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const MKOINWallet_errors = {
...
export const MKOINWallet_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const MKOINWallet_types: ABIType[] = [
...
export class MKOINWallet implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = MKOINWallet_errors_backward;
    public static readonly opcodes = MKOINWallet_opcodes;
    
    static async init(master: Address, owner: Address) {
        return await MKOINWallet_init(master, owner);
    }
    
    static async fromInit(master: Address, owner: Address) {
        const __gen_init = await MKOINWallet_init(master, owner);
        const address = contractAddress(0, __gen_init);
        return new MKOINWallet(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new MKOINWallet(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  MKOINWallet_types,
        getters: MKOINWallet_getters,
        receivers: MKOINWallet_receivers,
        errors: MKOINWallet_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: JettonTransfer | JettonInternalTransfer | JettonBurn) {
